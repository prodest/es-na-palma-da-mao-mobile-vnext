...
describe('Pagina de detalhes', () => {
    ...
    it('Testa o search', () => {
        let menu: any = element.all(by.className('bar-buttons bar-buttons-md bar-button bar-button-md bar-button-default bar-button-default-md bar-button-menutoggle bar-button-menutoggle-md')).first();
        menu.click()
        browser.driver.sleep(1000);
        element.all(by.buttonText("search")).click();
        browser.driver.sleep(1000);
